  ...
  return (
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Để lại nhu cầu cho chúng tôi</h2>
      </div>
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div className="sm:col-span-2">
            <label htmlFor="product" className="block text-sm/6 font-medium text-gray-900">
              Loại sản phẩm/hàng hoá bạn cần
            </label>
          ...
          <TextAreaField label='Phương thức thanh toán' />

          <FileUploadField
            label="Hình ảnh sản phẩm/hàng hoá"
            className="col-span-2"
          />
          <TextAreaField label='Lưu ý khác cho đơn hàng' className="sm:col-span-2" />
