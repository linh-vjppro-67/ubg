...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    developmentSection: Schema.Attribute.Component<
      'about-us.about-us-development-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    >;
    missionSection: Schema.Attribute.Component<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valueSection: Schema.Attribute.Component<
      'about-us.about-us-value-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiHomePricingHomePricing extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    prices: Schema.Attribute.Component<'shared.pricing', true>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHomePrimaryFeatureHomePrimaryFeature
  ...
  info: {
    displayName: 'HomePrimaryFeature';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    features: Schema.Attribute.Component<'shared.primary-feature', true> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHomeSecondaryFeatureHomeSecondaryFeature
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    features: Schema.Attribute.Component<'shared.secondary-feature', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
